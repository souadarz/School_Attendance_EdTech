...
import { getSessionAttendance, updateSessionAttendance } from "../services/attendanceService";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#46494c]">Take Attendance</h1>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={5} className="text-center py-8 text-[#4c5c68]">
                    Loading...
                  </td>
                </tr>
              ) : students.length === 0 ? (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <p className="text-2xl font-bold mt-1 text-orange-600">
            {students.filter((s) => s.status === AttendanceStatus.LATE).length}
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <p className="text-2xl font-bold mt-1 text-blue-600">
            {students.filter((s) => s.status === AttendanceStatus.EXCUSED).length}
          </p>
        </div>
      </div>
    </div>
